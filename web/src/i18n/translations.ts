...
export const translations = {
  en: {
    ...
    step1Desc: 'git clone the NOFX source and switch to dev branch to test new features.',
    ...
    step4Desc: 'Monitor trading and submit PRs to improve the framework.',
